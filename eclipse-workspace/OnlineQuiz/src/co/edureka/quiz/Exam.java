...
public class Exam {
	...
	{   int number=i;
	System.out.println("Inside setQuetion Method and i = "+i);
	    ...
	    for (int j = 0; j < childList.getLength(); j++) {
            ...
            if ("answer".equals(childNode.getNodeName()))
            {
                ...
                //System.out.println("childList= "+childList.item(j).getTextContent());
                System.out.println("Option= "+options[counter]);
            ...
            else if("quizquestion".equals(childNode.getNodeName()))
            {
            	...
            	System.out.println("quizquetuin= "+question+"\n");
            }
